...
//	    private TextField adrTField;
	    ...
	    lgnNameLbl.setPrefHeight(17);
	        ...
	        // Add to pane
	        pane3.getChildren().addAll(navnTField, PostnrTField, tlfTField, cprTField, mailTField, bilnavnTField,
	                HusnrTField    ,VejTField,ByTField,bilprisTField, udbetalingTField, laengdeTField, opretLaanBtn, opretStatusLbl, ferraripic, lgnNameLbl);
	...
	private void opretLaan() {
		...
		else if (laanlogic.LaanCheckDuplicate(cpr, tlf) == false ){
			checkRating();
		}
		else systemError();
	}
